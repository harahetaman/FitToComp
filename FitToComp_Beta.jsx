{
    //UI
    function FitToComp(thisObj){
    function FitToComp_UI(thisObj){
...
var FitToCompPalette = FitToComp_UI(thisObj);
if((FitToCompPalette != null) && (FitToCompPalette instanceof Window)){
    FitToCompPalette.show();
}
}
FitToComp(this);
}
